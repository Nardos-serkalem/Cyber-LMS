...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-lemon-500 text-navy-900 hover:bg-lemon-50 active:bg-lemon-700 active:text-navy-900",
  secondary: "bg-navy-900 text-lemon-500 hover:bg-navy-700 active:bg-navy-700",
  ghost:
    "bg-transparent text-navy-900 border border-navy-200 hover:bg-lemon-50 active:bg-lemon-700 active:text-navy-900",
};
